/**The given class, ChangeActiveInventory GUI is the GUI for the changing active gui on Inventory
 * <p>
...
public class ChangeActiveInventoryGUI extends javax.swing.JFrame {

    /**
     * Creates new form ChooseCreatureGUI
     */
    public ChangeActiveInventoryGUI() {
        initComponents();
        setSize(828, 535);
    ...
    private void initComponents() {
        ...
        backinvent.setBorderPainted(false);
        ...
        changeactive.setText("Please Select a Creature");
        ...
        slot5img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/circleshadow.png"))); // NOI18N
        ...
        slot1img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/circleshadow.png"))); // NOI18N
        ...
        slot2img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/circleshadow.png"))); // NOI18N
        ...
        slot3img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/circleshadow.png"))); // NOI18N
        slot3img.setText("jLabel1");
        leftpanel.add(slot3img);
        slot3img.setBounds(30, 320, 220, 190);

        slot4img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/circleshadow.png"))); // NOI18N
        ...
        slot6img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/circleshadow.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(leftpanel, javax.swing.GroupLayout.PREFERRED_SIZE, 823, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void setBackinvent(ActionListener listener) {
        backinvent.addActionListener(listener);
    }
    public void setOption1Inventory(ActionListener listener) {
        option1.addActionListener(listener);
    }
    public void setOption2Inventory(ActionListener listener) {
        option2.addActionListener(listener);
    }
    public void setOption3Inventory(ActionListener listener) {
        option3.addActionListener(listener);
    }
    public void setOption4Inventory(ActionListener listener) {
        option4.addActionListener(listener);
    }
    public void setOption5Inventory(ActionListener listener) {
        option5.addActionListener(listener);
    }
    public void setOption6Inventory(ActionListener listener) {
