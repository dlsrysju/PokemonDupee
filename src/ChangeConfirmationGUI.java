/**The given class, ChangeConfirmationGUI is the GUI for Swap confiriming the active creature change
 * <p>
...
public class ChangeConfirmationGUI extends javax.swing.JFrame {

    /**
     * Creates new form ConfirmChangeCreature
     */
    public ChangeConfirmationGUI() {
        initComponents();
        setSize(420, 339);
    ...
    public void setActiveCreatureFLevel(String text){
        this.activecreatureLevel.setText(text);
    }

    public void yesActionListener(ActionListener listener) {
        yes.addActionListener(listener);
    }
    public void noActionListener(ActionListener listener) {
        no.addActionListener(listener);
    }

    public void yesInventory(ActionListener listener) {
        yes.addActionListener(listener);
    }
    public void noInventory(ActionListener listener) {
        no.addActionListener(listener);
    }
